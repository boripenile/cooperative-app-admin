...
<b-row>
    <b-colxx class="disable-text-selection">
        <b-row>
            <b-colxx xxs="12">
                <h1>{{ $t('menu.transactions-list') }}</h1>
...
export default {
    ...
    data() {
        return {
            ...
            apiBaseUrl: apiBaseUrl + '/transactions',
            displayMode: 'list',
            sort: {
    ...
    computed: {
        ...
        apiUrl() {
            // return `${this.apiBase}/users/all?sort=${this.sort.column}&page=${this.page}&per_page=${this.perPage}&search=${this.search}`
